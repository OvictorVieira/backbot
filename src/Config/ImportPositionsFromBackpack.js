      ...
      for (const position of positions) {
        try {
          ...
          if (quantity && quantity > 0) {
            console.log(`📝 [IMPORT_POSITIONS] Importando posição: ${symbol} - ${quantity} @ ${price}`);
      ...
      for (const position of positions) {
        try {
          ...
          if (quantity && quantity > 0) {
            ...
            console.log(`📝 [IMPORT_POSITIONS] Importando posição: ${symbol} - ${quantity} @ ${price} para Bot ${botId}`);
